...
import error505Image from '../assets/error505.png';

const Error505Page: React.FC = () => {
  ...
  return (
    <div className={`flex flex-col items-center justify-center min-h-screen ${isDarkMode ? 'bg-gray-900' : 'bg-zinc-100'} relative`}>
      ...
      <p className={`text-xl font-normal font-['Roboto'] leading-7 text-center max-w-[600px] mb-8 ${isDarkMode ? 'text-gray-400' : 'text-black/40'}`}>
        Something went wrong with the connection protocol. Please refresh the page or contact support if the problem persists.
      </p>
      ...
      <div className="flex gap-3">
        <button
          ...
          className="px-3.5 py-1 bg-cyan-500 rounded-sm shadow-sm text-white text-sm font-normal font-['Roboto'] leading-5 hover:bg-cyan-600 transition-colors"
        >
          Refresh Page
        </button>
        <button
