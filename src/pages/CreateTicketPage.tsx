...
const CreateTicketPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const payload = {
      ...
      priority,
      category: project.trim() || undefined,
      createdById: 1,
    };
    ...
    <div className={`flex h-screen ${isDarkMode ? "bg-gray-900" : "bg-gray-50"} transition-colors duration-300`}>
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-4xl mx-auto px-6 py-8">
          ...
          {errorMsg && (
            <div
              className={`mb-6 p-4 rounded-xl flex items-center gap-3 ${isDarkMode ? "bg-red-900/30 text-red-400" : "bg-red-50 text-red-700"
                }`}
            >
          ...
          {showSuccessPopup && (
            <div className="fixed inset-0 z-50 flex items-center justify-center">
              ...
              {/* Modal */}
              <div className={`relative z-10 w-full max-w-md mx-4 p-6 rounded-2xl shadow-2xl transform transition-all ${isDarkMode ? 'bg-gray-800' : 'bg-white'
                }`}>
                {/* Success Icon */}
                ...
                {/* Title */}
                <h3 className={`text-xl font-semibold text-center mb-2 ${isDarkMode ? 'text-gray-100' : 'text-gray-900'
                  }`}>
                  Ticket Created!
                </h3>
                ...
                <p className={`text-center mb-6 ${isDarkMode ? 'text-gray-400' : 'text-gray-500'
                  ...
                  Your ticket has been successfully created and submitted.
                </p>
                ...
                <div className={`p-4 rounded-xl mb-6 ${isDarkMode ? 'bg-gray-700/50' : 'bg-gray-50'
                  ...
                  <div className="flex items-center gap-3">
                    <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${isDarkMode ? 'bg-teal-600/20' : 'bg-teal-50'
                      }`}>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className={`text-xs ${isDarkMode ? 'text-gray-500' : 'text-gray-400'}`}>
                        Priority: {selectedPriority?.label} • {attachments.length} attachment{attachments.length !== 1 ? 's' : ''}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    className="flex-1 px-4 py-2.5 rounded-xl font-medium bg-teal-600 hover:bg-teal-700 text-white transition-all"
                  >
                    Done
                  </button>
                </div>
          ...
          <div className={`${isDarkMode ? "bg-gray-800" : "bg-white"} rounded-2xl shadow-sm overflow-hidden`}>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    <button
                      ...
                      className={`w-full px-4 py-3 rounded-xl border-2 transition-all flex items-center justify-between ${isDarkMode
                        ...
                        <div className={`absolute top-full left-0 right-0 mt-2 rounded-xl shadow-lg z-20 overflow-hidden ${isDarkMode ? 'bg-gray-700 border border-gray-600' : 'bg-white border border-gray-200'
                          ...
                          {PRIORITY_OPTIONS.map((opt) => (
                            <button
                              ...
                              className={`w-full px-4 py-3 flex items-center gap-3 transition-colors ${priority === opt.value
              ...
              <div>
                ...
                <textarea
                  className={`w-full px-4 py-3 rounded-xl border-2 transition-all resize-none ${isDarkMode
                      ? "bg-gray-700/50 border-gray-600 text-gray-100 placeholder-gray-500 focus:border-teal-500"
                      : "bg-gray-50 border-gray-200 text-gray-800 placeholder-gray-400 focus:border-teal-500"
                    } focus:outline-none focus:ring-2 focus:ring-teal-500/20`}
              ...
              <div className={`flex items-center justify-between pt-6 border-t ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`}>
                <button
                  type="button"
                  onClick={resetForm}
                  className={`px-4 py-2.5 rounded-xl text-sm font-medium transition-colors ${isDarkMode
                ...
                <div className="flex items-center gap-3">
                  <button
                    type="button"
                    onClick={() => navigate(-1)}
                    className={`px-5 py-2.5 rounded-xl font-medium transition-all ${isDarkMode
                        ? 'bg-gray-700 text-gray-300 hover:bg-gray-600'
                        : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                      }`}
                  >
                  ...
                  <button
                    type="submit"
                    disabled={!canSubmit}
                    className={`flex items-center gap-2 px-6 py-2.5 rounded-xl font-medium transition-all ${canSubmit
