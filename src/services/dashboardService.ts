  ...
  async getNotifications(limit: number = 5): Promise<DashboardNotification[]> {
    ...
    const allNotifications: DashboardNotification[] = [
      ...
      },
      {
        ...
        description: 'Your solution for TCK-087 was approved',
        time: '8 hours ago',
        read: true,
      },
      {
        ...
        type: 'warning',
        title: 'SLA Warning',
        description: 'TCK-234 is approaching SLA deadline',
        time: '10 hours ago',
        read: true,
      },
      {
      ...
      },
      {
        ...
        description: 'TCK-156 needs manager approval',
        time: '1 day ago',
        read: true,
      },
      {
        ...
        description: 'You resolved 50 tickets this month!',
        time: '2 days ago',
        read: false,
      },
    ];
